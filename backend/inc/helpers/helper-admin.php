...
class HelperAdmin
{
					...
					<div class="short_wrap">
						<div class="short_inner">
							<div class="short_header">
								<h3>'.esc_html__('Shortcode', 'bookmify').'</h3>
							</div>
							<div class="short_list">
								<ul>
									<li>
										<div class="item">
											<span class="text">[bookmify_app_alpha]</span>
										</div>
									</li>
								</ul>
							</div>
						...
						<div class="help_inner">
							...
							<div class="help_list">
								<ul>
									...
									<li>
										<a href="https://codecanyon.net/user/frenify" target="_blank">
											<span class="icon">
	...
	public static function bookmifyHeader(){
...
//								</div>';
	...
	public static function bookmifyAdminContentStart(){
