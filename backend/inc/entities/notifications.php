...
class Notifications{
							...
							<div class="bookmify_be_notifications_list">
								...
								<div class="bookmify_be_tab_wrap">
									<div class="bookmify_be_link_tabs">
										<ul>
											<li class="active"><a href="#" class="bookmify_be_tab_link"><?php esc_html_e('To Customers', 'bookmify'); ?></a></li>
											<li><a href="#" class="bookmify_be_tab_link"><?php esc_html_e('To Employee', 'bookmify'); ?></a></li>
										</ul>
									</div>
	...
	*/
    private function numberOfNotification()
    {
		...
		$query = "SELECT COUNT(*) FROM {$wpdb->prefix}bmify_notifications";
