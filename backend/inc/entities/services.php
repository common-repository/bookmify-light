				...
				<div class="bookmify_be_service_content">
					...
					<div class="bookmify_be_services">
						...
						<div class="bookmify_be_service_list">
							<?php echo wp_kses_post($this->serviceList()); ?>
						</div>
					</div>
					<!-- SERVICE LIST -->
				</div>
	...
	public function ajaxQueryEditService(){
		...
		if (!empty($_POST['bookmify_data'])) {
			...
			foreach($services as $service){
				$attachment_url 		= Helper::bookmifyGetImageByID($service->attachment_id);
				$attachment_url_large 	= Helper::bookmifyGetImageByID($service->attachment_id, 'large');
				$selected	 			= bookmify_be_checked($service->visibility, "public");
				if($attachment_url != ''){$opened = 'has_image';}else{$opened = '';}
				$price 					= Helper::bookmifyPriceCorrection($service->price);
				$duration 				= Helper::bookmifyNumberToDuration($service->duration);
				$buffer_before 			= Helper::bookmifyNumberToDuration($service->buffer_before);
				$buffer_after 			= Helper::bookmifyNumberToDuration($service->buffer_after);
				$category_name 			= HelperServices::categoryIDToName($service->category_id);
				$employee_ids 			= HelperServices::employeeIDsByServiceID($service->id);
				$employee_list 			= HelperServices::employeeAsNewValue($service->id);

				$employeePlaceholder = '';
				if($employee_list == ''){
					$employeePlaceholder = esc_attr__('Select from Employees','bookmify');
				}
				$html .= '<div class="bookmify_be_popup_form_wrap" data-entity-id="'.$service->id.'">
								...
								<div class="bookmify_be_popup_form_bg">
									<div class="bookmify_be_popup_form">
										...
										<div class="bookmify_be_popup_form_header">
											<h3>'.esc_html__('Edit Service','bookmify').'</h3>
															...
															<form class="bookmify_be_main_form service_update" autocomplete="off">
																...
																<div class="bookmify_be_tabs_content_service_edit bookmify_be_content_tabs">
																		...
																		<div class="bookmify_be_service_edit_detail">
																			<div class="left_part">
																				<div class="input_wrap input_img">
																					...
																					<div class="bookmify_thumb_wrap '.$opened.'" style="background-image:url('.$attachment_url_large.')">
																						...
																						<div class="bookmify_thumb_remove '.$opened.'"><a href="#" class="bookmify_be_delete" data-entity-id="'.$service->id.'"><img class="bookmify_be_svg" src="'.BOOKMIFY_ASSETS_URL.'img/delete.svg" alt="" /></a></div>
																					</div>
																				</div>
																				<div class="color_visible">
																					...
																					<div class="visibility">
																						<label class="switch">
																							<input type="checkbox" id="repeat_1_'.$service->id.'" value="1" name="service_visibility" '.$selected.' />
																							<span class="slider round"></span>
																						</label>
																						<label class="repeater" for="repeat_1_'.$service->id.'">'.esc_html__('Visible to Public','bookmify').'</label>
																					</div>
																				</div>
																			</div>
																			<div class="right_part">
																				<div class="name_price">
																					...
																					<div class="price_holder" data-price="'.$service->price.'">
																						<label><span class="title">'.esc_html__('Price','bookmify').'<span>*</span></span></label>
																						<input class="required_field" type="number" step="0.01" name="service_price" placeholder="'.esc_attr__('Service Price','bookmify').'" value="'.$service->price.'" />
																					</div>
																				</div>
																				<div class="category_employees">
																					<div class="category_holder">
																						...
																						<input type="hidden" name="service_category_id" value="'.$service->category_id.'">
																				...
																				<div class="duration_buffer">
																					<div class="duration">
																						...
																						<input type="hidden" name="service_duration_sec" value="'.$service->duration.'">
																						<span class="bot_btn"><span></span><img class="bookmify_be_svg" src="'.BOOKMIFY_ASSETS_URL.'img/down.svg" alt="" /></span>
																					</div>
																					<div class="buffer_before">
																						...
																						<input type="hidden" name="service_bb_sec" value="'.$service->buffer_before.'">
																						<span class="bot_btn"><span></span><img class="bookmify_be_svg" src="'.BOOKMIFY_ASSETS_URL.'img/down.svg" alt="" /></span>
																					</div>
																					<div class="buffer_after">
																						...
																						<input type="hidden" name="service_ba_sec" value="'.$service->buffer_after.'">
																						<span class="bot_btn"><span></span><img class="bookmify_be_svg" src="'.BOOKMIFY_ASSETS_URL.'img/down.svg" alt="" /></span>
																					</div>
																				</div>
																	...
																	<div class="bookmify_be_tab_pane">
																		'.HelperServices::bookmifyGalleryListServiceByID($service->id).'
																	</div>
																	<div class="bookmify_be_tab_pane">
																		<div class="bookmify_be_extra_service_edit">
																			<div class="bookmify_light_info">
																				'.__('Light Version doesn\'t support extras. Please, upgrade to Bookmify (PRO) to get all possibilites of Bookmify and technical support 24/7.', 'bookmify').'
																				<span><a target="_blank" href="https://codecanyon.net/item/bookmify-appointment-booking-wordpress-plugin/23837899"></a>pro
																			</div>
																		</div>
																	</div>
																</div>
