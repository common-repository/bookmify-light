				...
				<div class="bookmify_be_payments">
					...
					<div class="bookmify_be_payments_list">
						<div class="bookmify_be_payment_list_content">
							<?php echo wp_kses_post($this->paymentsList()); ?>
						</div>
					</div>
					<!-- /Payment List -->
	...
	public function ajaxQueryOpenPaymentDetails(){
		...
		if (!empty($_POST['bookmify_data'])) {
			...
			foreach($payments as $payment){
				...
				$appDate		= date_i18n($this->dateformat, strtotime($payment->appDate));
				// ------------------------------------------------------------------------------------------------
				$createdDay 	= date_i18n($this->dateformat, strtotime($payment->paymentCreatedDate));
				// ------------------------------------------------------------------------------------------------
				...
				// ------------------------------------------------------------------------------------------------
				$paymentDue		= $payment->paymentTotalPrice - $payment->paymentPaidSum >= 0 ? $payment->paymentTotalPrice - $payment->paymentPaidSum : 0;
				// ------------------------------------------------------------------------------------------------
				...
				$html .= '<div class="bookmify_be_popup_form_wrap" data-entity-id="'.$payment->paymentID.'">
									...
									<div class="bookmify_be_popup_form">
												...
												<div class="detail_box">
													...
													<div class="detail_box_content">
														<div class="detail_box_row">
															...
															<div class="detail_box_col col_right"><span>'.$payment->customerFirstName.' '.$payment->customerLastName.'</span></div>
														</div>
														<div class="detail_box_row">
															<div class="detail_box_col col_left"><span>'.esc_html__('Email:', 'bookmify').'</span></div>
															<div class="detail_box_col col_right"><span>'.$payment->customerEmail.'</span></div>
														</div>';
										...
										if($payment->customerPhone != ''){
											$html .= '	<div class="detail_box_row">
															...
															<div class="detail_box_col col_right"><span>'.$payment->customerPhone.'</span></div>
														</div>';
										}
												...
												<div class="detail_box">
													...
													<div class="detail_box_content">
														...
														<div class="detail_box_row">
															...
															<div class="detail_box_col col_right"><span>'.$payment->serviceTitle.'</span></div>
														</div>
														<div class="detail_box_row">
															<div class="detail_box_col col_left"><span>'.esc_html__('Employee:', 'bookmify').'</span></div>
															<div class="detail_box_col col_right"><span>'.$payment->employeeFirstName.' '.$payment->employeeLastName.'</span></div>
														</div>
													</div>
												</div>
												...
												<div class="detail_box highlighted">
													<div class="detail_box_content">
														...
														<div class="detail_box_row">
															...
															<div class="detail_box_col col_right"><span>'.Helper::bookmifyPriceCorrection($payment->paymentPaidSum).'</span></div>
														</div>
														<div class="detail_box_row">
														...
														<div class="detail_box_row total">
															...
															<div class="detail_box_col col_right"><span>'.Helper::bookmifyPriceCorrection($payment->paymentTotalPrice).'</span></div>
														</div>
													</div>
												</div>
