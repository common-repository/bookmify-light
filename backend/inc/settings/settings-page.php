...
abstract class Settings_Page {
	...
	*/
	...
	public function hours_popup($day, $class= NULL,$start = NULL){
		...
		$timeDiv		= '<div class="nano scrollbar-inner '.$day.' '.$class.'" data-start="'.$start.'" data-class="'.$day.'"><div class="nano-content">';
		$startTime = strtotime('00:00');
		for($i = 0; $i < $countInterval; $i++){
			$timeDiv .= '<div>'.date("H:i", strtotime('+'.$i*$timeInterval.' minutes', $startTime)).'</div>';
		}
		$timeDiv .= '</div></div>';
		return $timeDiv;
	}
									...
									<div class="general_items">
										<div class="general_item_group">
											...
											<div class="general_item">
												<div class="item_title"><label for="gc_client_id"><?php esc_html_e('Client ID', 'bookmify'); ?></label></div>
											...
											<!-- Client Secret -->
											<div class="general_item">
												<div class="item_title"><label for="gc_client_secret"><?php esc_html_e('Client Secret', 'bookmify'); ?></label></div>
										...
										<div class="general_item_group">
											<!-- Redirect URL -->
											<div class="general_item">
												<div class="item_title"><label for="gc_redirect_url"><?php esc_html_e('Redirect URL', 'bookmify'); ?></label></div>
												<div class="item_content"><input id="gc_redirect_url" readonly name="bookmify_be_gc_redirect_url" type="text" value="" /></div>
											</div>
											<!-- /Redirect URL -->

											<!-- Maximum Number Of Events Returned -->
											<div class="general_item">
												<div class="item_title"><label for="gc_max_num_events"><?php esc_html_e('Maximum Number Of Events Returned', 'bookmify'); ?></label></div>
										...
										<div class="general_item_group">
											...
											<div class="general_item">
												<div class="item_title"><label for="gc_add_pending_app"><?php esc_html_e('Add Pending Appointments', 'bookmify'); ?></label></div>
											...
											<div class="general_item">
												<div class="item_title"><label for="gc_add_event_attendees"><?php esc_html_e('Add Event\'s Attendees', 'bookmify'); ?></label></div>
												<div class="item_content">
													<label class="bookmify_be_switch">
											...
											<div class="general_item">
												<div class="item_title"><label for="gc_send_event_invitation"><?php esc_html_e('Send Event Invitation Email', 'bookmify'); ?></label></div>
												<div class="item_content">
													<label class="bookmify_be_switch">
											...
											<div class="active bookmify_be_tab_pane">
												...
												<form method="post" action="" class="bookmify_working_hours">
													...
													<?php 
														...
														if($moSWH !== ''){$moChecked = 'checked="checked"';}
														if($tuSWH !== ''){$tuChecked = 'checked="checked"';}
														if($weSWH !== ''){$weChecked = 'checked="checked"';}
														if($thSWH !== ''){$thChecked = 'checked="checked"';}
														if($frSWH !== ''){$frChecked = 'checked="checked"';}
														if($saSWH !== ''){$saChecked = 'checked="checked"';}
														if($suSWH !== ''){$suChecked = 'checked="checked"';}
													?>
														...
														<li class="monday">
															<div class="item hour_item">
																<div class="item_wh">
																	...
																	<div class="hours">
																		<div class="start"><input class="time" readonly autocomplete="off" name="bookmify_be_monday_start" type="text" value="<?php echo get_option('bookmify_be_monday_start', '08:00'); ?>" /></div>
																		<div class="end"><input class="time" readonly autocomplete="off" name="bookmify_be_monday_end" type="text" value="<?php echo get_option('bookmify_be_monday_end', '18:00'); ?>" /></div>
																	</div>
																</div>
																<div class="item_bh">
																	<div class="day">
														...
														<li class="tuesday">
															<div class="item hour_item">
																<div class="item_wh">
																	...
																	<div class="hours">
																		<div class="start"><input class="time" readonly autocomplete="off" name="bookmify_be_tuesday_start" type="text" value="<?php echo get_option('bookmify_be_tuesday_start', '08:00'); ?>" /></div>
																		<div class="end"><input class="time" readonly autocomplete="off" name="bookmify_be_tuesday_end" type="text" value="<?php echo get_option('bookmify_be_tuesday_end', '18:00'); ?>" /></div>
																	</div>
																</div>
																<div class="item_bh">
																	<div class="day">
														...
														<li class="wednesday">
															<div class="item hour_item">
																<div class="item_wh">
																	...
																	<div class="hours">
																		<div class="start"><input class="time" readonly autocomplete="off" name="bookmify_be_wednesday_start" type="text" value="<?php echo get_option('bookmify_be_wednesday_start', '08:00'); ?>" /></div>
																		<div class="end"><input class="time" readonly autocomplete="off" name="bookmify_be_wednesday_end" type="text" value="<?php echo get_option('bookmify_be_wednesday_end', '18:00'); ?>" /></div>
																	</div>
																</div>
																<div class="item_bh">
																	<div class="day">
														...
														<li class="thursday">
															<div class="item hour_item">
																<div class="item_wh">
																	...
																	<div class="hours">
																		<div class="start"><input class="time" readonly autocomplete="off" name="bookmify_be_thursday_start" type="text" value="<?php echo get_option('bookmify_be_thursday_start', '08:00'); ?>" /></div>
																		<div class="end"><input class="time" readonly autocomplete="off" name="bookmify_be_thursday_end" type="text" value="<?php echo get_option('bookmify_be_thursday_end', '18:00'); ?>" /></div>
																	</div>
																</div>
																<div class="item_bh">
																	<div class="day">
														...
														<li class="friday">
															<div class="item hour_item">
																<div class="item_wh">
																	...
																	<div class="hours">
																		<div class="start"><input class="time" readonly autocomplete="off" name="bookmify_be_friday_start" type="text" value="<?php echo get_option('bookmify_be_friday_start', '08:00'); ?>" /></div>
																		<div class="end"><input class="time" readonly autocomplete="off" name="bookmify_be_friday_end" type="text" value="<?php echo get_option('bookmify_be_friday_end', '18:00'); ?>" /></div>
																	</div>
																</div>
																<div class="item_bh">
																	<div class="day">
														...
														<li class="saturday">
															<div class="item hour_item">
																<div class="item_wh">
																	...
																	<div class="hours">
																		<div class="start"><input class="time" readonly autocomplete="off" name="bookmify_be_saturday_start" type="text" value="<?php echo get_option('bookmify_be_saturday_start', '08:00'); ?>" /></div>
																		<div class="end"><input class="time" readonly autocomplete="off" name="bookmify_be_saturday_end" type="text" value="<?php echo get_option('bookmify_be_saturday_end', '18:00'); ?>" /></div>
																	</div>
																</div>
																<div class="item_bh">
																	<div class="day">
														...
														<li class="sunday">
															<div class="item hour_item">
																<div class="item_wh">
																	...
																	<div class="hours">
																		<div class="start"><input class="time" readonly autocomplete="off" name="bookmify_be_sunday_start" type="text" value="<?php echo get_option('bookmify_be_sunday_start', '08:00'); ?>" /></div>
																		<div class="end"><input class="time" readonly autocomplete="off" name="bookmify_be_sunday_end" type="text" value="<?php echo get_option('bookmify_be_sunday_end', '18:00'); ?>" /></div>
																	</div>
																</div>
																<div class="item_bh">
																	<div class="day">
								...
								<form method="post" action="" class="bookmify_settings_form bookmify_customer_options">
									...
									<div class="general_item">
										<div class="item_title">
											<label for="customers_pp"><?php esc_html_e('Customers Per Page', 'bookmify'); ?></label>
										</div>
										<div class="item_content">
							...
							<div class="bookmify_be_settings_payments">
								<form method="post" action="" class="bookmify_settings_form bookmify_payment_options">
									...
									<div class="general_items">
										...
										<div class="general_item_group">
											<div class="general_item">
												<div class="item_title"><label><?php esc_html_e('Payments Per Page', 'bookmify'); ?></label></div>
												<div class="item_content">
											...
											<div class="general_item">
												<div class="item_title"><label><?php esc_html_e('Payment Filter Date Range', 'bookmify'); ?></label></div>
												<div class="item_content">
										...
										<div class="general_item_group">
											<div class="general_item">
												<div class="item_title"><label for="currency_format"><?php esc_html_e('Currency Format', 'bookmify'); ?></label></div>
												<div class="item_content">
													<?php 
											...
											<div class="general_item">
												<div class="item_title"><label for="currency_position"><?php esc_html_e('Currency Position', 'bookmify'); ?></label></div>
												<div class="item_content">
											...
											<div class="general_item">
												<div class="item_title"><label for="price_format"><?php esc_html_e('Price Format', 'bookmify'); ?></label></div>
												<div class="item_content">
											...
											<div class="general_item">
												<div class="item_title"><label for="price_decimal"><?php esc_html_e('Price Decimal', 'bookmify'); ?></label></div>
												<div class="item_content">
										...
										<div class="general_item_group payment_item_group">
											...
											<div class="general_item">
												<div class="item_title"><label for="paypal_switch"><?php esc_html_e('Paypal', 'bookmify'); ?></label></div>
												<div class="item_content">
													<label class="bookmify_be_switch">
											...
											<div class="general_item paypal_sandbox_switch <?php echo esc_attr($paypalSwitch);?>">
												<div class="item_title"><label for="paypal_sandbox_mode"><?php esc_html_e('Paypal Sandbox Mode', 'bookmify'); ?></label></div>
												<div class="item_content">
													<label class="bookmify_be_switch">
											...
											<div class="general_item paypal_sandbox <?php echo esc_attr($payaplTest);?>">
												<div class="item_title">
													<label for="paypal_client_id"><?php esc_html_e('Sandbox Paypal Client ID', 'bookmify');?></label>
												</div>
												<div class="item_content">
											...
											<div class="general_item paypal_sandbox <?php echo esc_attr($payaplTest);?>">
												<div class="item_title">
													<label for="paypal_client_secret"><?php esc_html_e('Sandbox Paypal Client Secret', 'bookmify');?></label>
												</div>
												<div class="item_content">
											...
											<div class="general_item paypal_live <?php echo esc_attr($payaplLive);?>">
												<div class="item_title">
													<label for="paypal_client_id_live"><?php esc_html_e('Live Paypal Client ID', 'bookmify');?></label>
												</div>
												<div class="item_content">
											...
											<div class="general_item paypal_live <?php echo esc_attr($payaplLive);?>">
												<div class="item_title">
													<label for="paypal_client_secret_live"><?php esc_html_e('Live Paypal Client Secret', 'bookmify');?></label>
												</div>
												<div class="item_content">
										...
										<div class="general_item_group payment_item_group">
											...
											?>
											<div class="general_item">
												<div class="item_title"><label for="stripe_switch"><?php esc_html_e('Stripe', 'bookmify'); ?></label></div>
												<div class="item_content">
													<label class="bookmify_be_switch">
											...
											<div class="general_item stripe_test_switch <?php echo esc_attr($stripeSwitch);?>">
												<div class="item_title"><label for="stripe_test_mode"><?php esc_html_e('Stripe Test Mode', 'bookmify'); ?></label></div>
												<div class="item_content">
													<label class="bookmify_be_switch">
											...
											<div class="general_item stripe_test <?php echo esc_attr($stripeTest);?>">
												<div class="item_title">
													<label for="strpe_test_publishable_key"><?php esc_html_e('Test Stripe Publishable Key', 'bookmify');?></label>
												</div>
												<div class="item_content">
											...
											<div class="general_item stripe_test <?php echo esc_attr($stripeTest);?>">
												<div class="item_title">
													<label for="stripe_test_secret_key"><?php esc_html_e('Test Stripe Secret Key', 'bookmify');?></label>
												</div>
												<div class="item_content">
											...
											<div class="general_item stripe_live <?php echo esc_attr($stripeLive);?>">
												<div class="item_title">
													<label for="stripe_publishable_key"><?php esc_html_e('Live Stripe Publishable Key', 'bookmify');?></label>
												</div>
												<div class="item_content">
											...
											<div class="general_item stripe_live <?php echo esc_attr($stripeLive);?>">
												<div class="item_title">
													<label for="stripe_secret_key"><?php esc_html_e('Live Stripe Secret Key', 'bookmify');?></label>
												</div>
												<div class="item_content">
						...
						<div id="tab-7" class="tab-pane fade bookmify-settings-services-page">
							...
							<div class="bookmify_be_settings_service">
								<form method="post" action="" class="bookmify_settings_form bookmify_service_options">
									...
									<div class="general_item">
										<div class="item_title"><label><?php esc_html_e('Services Per Page', 'bookmify'); ?></label></div>
										<div class="item_content">
